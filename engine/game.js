...
export function startNewGame(seed) {
  ...
  try {
    ...
    const sfx2 = ctx2.createGain(); sfx2.gain.value = 0.25; sfx2.connect(ctx2.destination);
    const mus2 = ctx2.createGain(); mus2.gain.value = 0.1; mus2.connect(ctx2.destination);
